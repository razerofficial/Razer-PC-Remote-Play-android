...
public class PreferenceConfiguration implements Serializable {
    ...
    public static final String STRETCH_PREF_STRING = "checkbox_stretch_video";
    public static final String SOPS_PREF_STRING = "checkbox_enable_sops";
    public static final String DISABLE_TOASTS_PREF_STRING = "checkbox_disable_warnings";
    public static final String HOST_AUDIO_PREF_STRING = "checkbox_host_audio";
    public static final String DEADZONE_PREF_STRING = "seekbar_deadzone";
    ...
    public static final String SMALL_ICONS_PREF_STRING = "checkbox_small_icon_mode";
    public static final String MULTI_CONTROLLER_PREF_STRING = "checkbox_multi_controller";
    public static final String AUDIO_CONFIG_PREF_STRING = "list_audio_config";
    public static final String USB_DRIVER_PREF_SRING = "checkbox_usb_driver";
    public static final String VIDEO_FORMAT_PREF_STRING = "video_format";
    public static final String ONSCREEN_CONTROLLER_PREF_STRING = "checkbox_show_onscreen_controls";
    public static final String ONLY_L3_R3_PREF_STRING = "checkbox_only_show_L3R3";
    public static final String LEGACY_DISABLE_FRAME_DROP_PREF_STRING = "checkbox_disable_frame_drop";
    public static final String ENABLE_HDR_PREF_STRING = "checkbox_enable_hdr";
    public static final String ENABLE_PIP_PREF_STRING = "checkbox_enable_pip";
    public static final String ENABLE_PERF_OVERLAY_STRING = "checkbox_enable_perf_overlay";
    public static final String BIND_ALL_USB_STRING = "checkbox_usb_bind_all";
    public static final String MOUSE_EMULATION_STRING = "checkbox_mouse_emulation";
    public static final String ANALOG_SCROLLING_PREF_STRING = "analog_scrolling";
    public static final String MOUSE_NAV_BUTTONS_STRING = "checkbox_mouse_nav_buttons";
    ...
    public static final String VIBRATE_FALLBACK_PREF_STRING = "checkbox_vibrate_fallback";
    public static final String VIBRATE_FALLBACK_STRENGTH_PREF_STRING = "seekbar_vibrate_fallback_strength";
    public static final String FLIP_FACE_BUTTONS_PREF_STRING = "checkbox_flip_face_buttons";
    public static final String TOUCHSCREEN_TRACKPAD_PREF_STRING = "checkbox_touchscreen_trackpad";
    public static final String LATENCY_TOAST_PREF_STRING = "checkbox_enable_post_stream_toast";
    public static final String FRAME_PACING_PREF_STRING = "frame_pacing";
    public static final String ABSOLUTE_MOUSE_MODE_PREF_STRING = "checkbox_absolute_mouse_mode";
    public static final String ENABLE_AUDIO_FX_PREF_STRING = "checkbox_enable_audiofx";
    public static final String REDUCE_REFRESH_RATE_PREF_STRING = "checkbox_reduce_refresh_rate";
    ...
    public static void restoreDefaultResolutionAndFps(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        prefs.edit()
                .putString(RESOLUTION_PREF_STRING, DEFAULT_RESOLUTION)
                .putString(FPS_PREF_STRING, DEFAULT_FPS)
                .apply();
