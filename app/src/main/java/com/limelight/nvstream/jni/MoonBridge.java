...
public class MoonBridge {
    ...
    public static int bridgeDrSetup(int videoFormat, int width, int height, int redrawRate) {
        LimeLog.info("bridgeDrSetup "+((videoRenderer != null) ? videoRenderer.hashCode() : "null"));
    ...
    public static void setupBridge(VideoDecoderRenderer videoRenderer, AudioRenderer audioRenderer, NvConnectionListener connectionListener) {
        LimeLog.info("setupBridge "+((videoRenderer != null) ? videoRenderer.hashCode() : "null"));
    ...
    public static void cleanupBridge() {
        LimeLog.info("cleanupBridge "+((videoRenderer != null) ? videoRenderer.hashCode() : "null"));
